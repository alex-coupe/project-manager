    ...
    render() {
        ...
        return (
            <div>
                ...
                {this.props.fetching ? <Spinner /> : <Pagination startAt={this.props.startAt} name={this.props.name} recordsPerPage={this.props.recordsPerPage} filteredData={this.state.filteredData} tableHeaderOptions={this.props.tableHeaderOptions}/>}   
            </div>
        )
    }
}
